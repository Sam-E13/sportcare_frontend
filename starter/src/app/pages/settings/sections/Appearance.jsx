  ...
  return (
    <div className="w-full max-w-3xl 2xl:max-w-5xl">
      ...
      <p className="mt-0.5 text-balance text-sm text-gray-500 dark:text-dark-200">
        Personaliza la apariencia de tu aplicación. Puedes elegir entre varios
      </p>
      ...
      <div className="space-y-8">
        <div>
          <div>
            ...
            <p className="mt-0.5">
              Puedes elegir entre tres modos de tema: claro, oscuro y definido por el sistema.
            </p>
          </div>
          <RadioGroup
        ...
        <div>
          <div>
            ...
            <p className="mt-0.5">
              Elige un color que se utilizará como color principal para tu tema.
            </p>
          </div>
          <RadioGroup
            ...
            className="mt-2"
          >
            <Label className="sr-only">Elija el color del tema principal</Label>
        ...
        <div>
          <div>
            ...
            <p className="mt-0.5">
              Seleccione el esquema de colores claros que se utilizará para su tema.
            </p>
          </div>
          <RadioGroup
            ...
            className="mt-4"
          >
            <Label className="sr-only">Esquema de colores del modo claro del tema</Label>
        ...
        <div>
          <div>
            ...
            <p className="mt-0.5">
              Seleccione el esquema de colores oscuros que se utilizará para su tema.
            </p>
          </div>
          <RadioGroup
            ...
            className="mt-4"
          >
            <Label className="sr-only">Esquemas de color del modo oscuro</Label>
            <div className="mt-2 flex flex-wrap gap-4">
      ...
      <div>
        <div>
          ...
          <p className="mt-0.5">
            Elija la posición de notificación y el estilo de grupo para su aplicación
          </p>
        </div>
        <div className="mt-3">
          <p>Estilo del grupo de notificaciones</p>
          <RadioGroup
            value={theme.notification?.isExpanded ? "expand" : "stack"}
            onChange={(val) => theme.setNotificationExpand(val === "expand")}
            className="mt-3 text-center"
          >
            <Label className="sr-only">Estilo del grupo de notificaciones</Label>
        ...
        <div className="mt-4">
          <p>Conteo máximo de notificaciones</p>
          <RadioGroup
            value={theme.notification?.visibleToasts}
            onChange={(val) => theme.setNotificationMaxCount(val)}
            className="mt-3 text-center"
          >
            <Label className="sr-only">Conteo máximo de notificaciones</Label>
        ...
        <div className="mt-5 grid grid-cols-1 md:grid-cols-3">
          <p className="my-auto">Posición de notificación:</p>
          <Listbox
            classNames={{
      ...
      <div className="space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-3">
          <p className="my-auto">Diseño de tarjetas:</p>
          <Listbox
            classNames={{
              root: "mt-1.5 flex-1 md:col-span-2 md:mt-0",
            }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="mt-1.5 flex flex-1 items-center justify-between space-x-2 rounded-lg border border-gray-300 px-3 py-2 dark:border-dark-450 md:col-span-2 md:mt-0 rtl:space-x-reverse">
            <p className="text-gray-800 dark:text-dark-100">Modo monocromo</p>
            <Switch
