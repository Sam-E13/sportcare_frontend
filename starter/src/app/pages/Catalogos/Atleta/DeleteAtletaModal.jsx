...
const confirmMessages = {
  pending: {
    ...
    title: "¿Estás seguro?",
    description: "¿Estás seguro de que deseas eliminar este atleta? Una vez eliminado, no se puede recuperar.",
    actionText: "Eliminar"
  },
  success: {
    Icon: AnimatedTick,
  ...
  error: {
    ...
    description: "Ocurrió un error al intentar eliminar el atleta.",
    actionText: "Reintentar"
  }
};

export function DeleteAtletaModal({ onDelete, onClose, isOpen }) {
  ...
  const handleDelete = async () => {
    try {
      ...
      const loadingToast = toast.loading('Eliminando atleta...', {
        position: 'top-center'
      });
      
      // Primero esperamos a que termine la operación
      await onDelete();
      
      // Solo cuando se completa con éxito:
      ...
      // Cerrar el modal después de 1.5 segundos (opcional)
      setTimeout(() => {
        onClose();
      }, 1500);
