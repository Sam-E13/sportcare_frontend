...
export function DeporteDrawer({ isOpen, onClose, row }) {
              ...
              <div>
                ...
                <div className="mt-2 space-y-2">
                  <p className="text-sm text-gray-600 dark:text-dark-200">
                    <span className="font-medium">Nombre:</span> {deporte?.nombre}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-600 dark:text-dark-200">
                  {deporte?.descripcion || 'No hay descripción disponible'}
                </p>
              </div>
            </div>
          </div>
