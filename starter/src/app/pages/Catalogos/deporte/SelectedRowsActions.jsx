...
export function SelectedRowsActions({ table, onPrint }) {
  ...
  // Actualizar el handleDeleteRows para manejar errores
  ...
  // Función para manejar la impresión de las filas seleccionadas
  const handlePrintSelected = () => {
    if (selectedRows.length > 0) {
      const selectedDeportes = selectedRows.map(row => row.original);
      onPrint(selectedDeportes);
    }
  };
