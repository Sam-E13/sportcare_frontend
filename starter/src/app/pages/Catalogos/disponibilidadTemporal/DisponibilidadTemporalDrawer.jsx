...
export function DisponibilidadTemporalDrawer({ isOpen, close, row }) {
          ...
          <div className="flex justify-between px-4 sm:px-5">
            <div>
              ...
              <div className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {horario.profesional_salud_nombre || "Profesional no especificado"}
              </div>
            </div>
            <Button
              onClick={close}
          ...
          <div className="mt-6 space-y-6 px-4 sm:px-5">
            ...
            <div>
              ...
              <div className="mt-2 grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="mt-1 font-medium">
                    {formatDate(horario.fecha_inicio)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
            ...
            <div>
              ...
              <div className="mt-2">
                ...
                <p className="mt-1 font-medium">
                  {horario.dias_semana && Array.isArray(horario.dias_semana) 
                    ? horario.dias_semana.map(dia => diasSemana[dia]).join(', ')
                    : 'No especificados'}
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center font-semibold">
                {horario.activo ? (
                  <CheckCircleIcon className="mr-2 size-5 text-success" />
                ) : (
                  <XCircleIcon className="mr-2 size-5 text-error" />
                )}
                <span>Estado</span>
              </div>
              <div className="mt-2">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Esta disponibilidad está actualmente
                </p>
                <p className="mt-1 font-medium">
...
DisponibilidadTemporalDrawer.propTypes = {
