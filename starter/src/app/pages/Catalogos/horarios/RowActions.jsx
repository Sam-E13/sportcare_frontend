...
import { UpdateHorarioModal } from "./actions/UpdateHorarioModal";
import { DeleteHorarioAction } from "./actions/DeleteHorarioModal";
...
export function RowActions({ row, table }) {
  ...
  const handleUpdateSuccess = (updatedHorario) => {
    table.options.meta?.updateRow(row.original.id, updatedHorario);
  };
  ...
  return (
    <>
      ...
      <HorarioDrawer row={row} close={closeDrawer} isOpen={isDrawerOpen} />
