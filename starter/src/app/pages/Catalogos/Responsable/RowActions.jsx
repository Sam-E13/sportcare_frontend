...
export function RowActions({ row, table }) {
  ...
  const handleEditSuccess = (updatedResponsable) => {
    table.options.meta?.updateData(row.index, 'nombre', updatedResponsable.nombre);
    table.options.meta?.updateData(row.index, 'parentesco', updatedResponsable.parentesco);
    table.options.meta?.updateData(row.index, 'telefono', updatedResponsable.telefono);
