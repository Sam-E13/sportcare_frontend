...
import { CreateGrupoDeportivoModal } from "./actions/CreateGrupoDeportivoModal";
...
export function Toolbar({ table, onPrint }) {
  ...
  const handleCreateSuccess = (newGrupo) => {
    table.options.meta?.addRow(newGrupo);
  };
